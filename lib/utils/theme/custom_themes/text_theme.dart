...
class MedicaTextTheme{
  ...
  static TextTheme lightTextTheme = TextTheme(
    headlineLarge: const TextStyle().copyWith(fontSize: 32.0,fontWeight: FontWeight.bold,color: MedicaColors.primary),
  ...
  static TextTheme darkTextTheme = TextTheme(
    headlineLarge: const TextStyle().copyWith(fontSize: 34.0,fontWeight: FontWeight.bold,color: MedicaColors.primary),
